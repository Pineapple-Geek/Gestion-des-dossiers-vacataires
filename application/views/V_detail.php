            ...
            <form class="form-horizontal" action="<?php echo site_url("C_agent/validation"); ?>" method="post">
                <div class="form-row justify-content-center">
                    <div class="col">
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation1" type="radio" value="Madame" required>Valide</input> <input name="validation1" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation2" type="radio" value="Madame" required>Valide</input> <input name="validation2" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation3" type="radio" value="Madame" required>Valide</input> <input name="validation3" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation4" type="radio" value="Madame" required>Valide</input> <input name="validation4" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation5" type="radio" value="Madame" required>Valide</input> <input name="validation5" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation6" type="radio" value="Madame" required>Valide</input> <input name="validation6" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation7" type="radio" value="Madame" required>Valide</input> <input name="validation7" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation8" type="radio" value="Madame" required>Valide</input> <input name="validation8" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation9" type="radio" value="Madame" required>Valide</input> <input name="validation9" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation10" type="radio" value="Madame" required>Valide</input> <input name="validation10" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation11" type="radio" value="Madame" required>Valide</input> <input name="validation11" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation12" type="radio" value="Madame" required>Valide</input> <input name="validation12" type="radio" value="Monsieur" required>Non Valide</input></span>
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation13" type="radio" value="Madame" required>Valide</input> <input name="validation13" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                </div>
        </div>
    </div>
            ...
            <form>
                <div class="form-row">
                    <div class="col-sm-5">
                        ...
                        <label class="col-sm-5 col-form-label text-right"></label><span class="validationStyle"><input name="validation14" type="radio" value="Madame" required>Valide</input> <input name="validation14" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                </div>
                <fieldset id="formEtat">
                    ...
                    <div class="col"> 
                        ...
                        <label class="col-sm-6 col-form-label text-right"></label><span class="validationStyle"><input name="validation14" type="radio" value="Madame" required>Valide</input> <input name="validation14" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <label class="col-sm-3 col-form-label text-right"></label><span class="validationStyle"><input name="validation13" type="radio" value="Madame" required>Valide</input> <input name="validation13" type="radio" value="Monsieur" required>Non Valide</input></span><br>
                    </div>
                    <div class="col">
                        ...
                        <label class="col-sm-4 col-form-label text-right"></label><span class="validationStyle"><input name="validation14" type="radio" value="Madame" required>Valide</input> <input name="validation14" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <label class="col-sm-3 col-form-label text-right"></label><span class="validationStyle"><input name="validation14" type="radio" value="Madame" required>Valide</input> <input name="validation14" type="radio" value="Monsieur" required>Non Valide</input></span>
                    </div>
                    <div class="col">
