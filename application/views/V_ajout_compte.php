        ...
        <form class="form-horizontal" action="<?php echo site_url('C_administrateur/validation'); ?>" method="post">
            <div class="form-row justify-content-center">
                <div class="col bg-light">
                    <label for="login" class="col-sm-5 col-form-label text-right">Identifiant:</label> <input class="input" type="text" name="login" id="login" required><br>
                    <label for ="Password" class="col-sm-5 col-form-label text-right">Mots de passe:</label> <input class="input" type="password" name="Password" id="Password" required><br>
